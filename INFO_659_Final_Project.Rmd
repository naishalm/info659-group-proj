...
```{r}
kmeans.model.persons.details = kmeans(train.encoded.person, centers=4, nstart=1)

kmeans.model.persons.details
```

### Fit the data to the model - crash details
```{r}
kmeans.model.crash.details = kmeans(train.encoded.crash.details, centers=4, nstart=1)

kmeans.model.crash.details
```

### Fit the data to the model - crash conditions
```{r}
kmeans.model.conditions = kmeans(train.encoded.crash.conditions, centers=4, nstart=1)

kmeans.model.conditions
```
